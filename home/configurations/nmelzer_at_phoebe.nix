...
in {
  ...
  sops.defaultSopsFile = "${inputs.self}/secrets/phoebe/nmelzer/default.yaml";
  ...
  sops.secrets."github" = {
    ...
    mode = "0400";
    sopsFile = "${inputs.self}/secrets/users/nmelzer/github";
    format = "binary";
  };
  ...
  sops.secrets."gitlab" = {
    ...
    mode = "0400";
    sopsFile = "${inputs.self}/secrets/users/nmelzer/gitlab";
    format = "binary";
  };
  ...
  sops.secrets."nobbz_dev" = {
    ...
    mode = "0400";
    sopsFile = "${inputs.self}/secrets/users/nmelzer/nobbz_dev";
    format = "binary";
  };
